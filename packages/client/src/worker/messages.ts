...
export type MainToWorkerMessage =
  | { type: 'init'; interpreter: ArrayBuffer; story: Uint8Array; storyName: string; args: string[]; metrics: Metrics; support?: string[]; storyId: string; filesystem: FilesystemMode; recordTranscript?: boolean; sessionId?: string; transcriptLabel?: string; replayInputs?: ReplayEvent[] }
